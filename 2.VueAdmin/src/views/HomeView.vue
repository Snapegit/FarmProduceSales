				...
				<el-card v-show="cardTypeList.closeordersChartType2" class="card_view">
					...
					<el-collapse-transition>
						<div class="card_item" v-show="cardTypeList.hiddenordersChartType2">
							<div id="orderstotalEchart2" style="width: 100%;height: 400px;"></div>
						</div>
					</el-collapse-transition>
				</el-card>
			</el-collapse-transition>
				...
				<el-card v-show="cardTypeList.closeordersChartType3" class="card_view">
						...
						<div class="index_card_head">
							...
							<div class="card_head_right">
								<el-icon @click="cardTypeClick('hiddenordersChartType3')" class="showIcons"
									:class="cardTypeList.hiddenordersChartType3?'showIcons1':''">
									<ArrowUpBold />
								</el-icon>
					...
					<el-collapse-transition>
						<div class="card_item" v-show="cardTypeList.hiddenordersChartType3">
							<div id="orderstotalEchart3" style="width: 100%;height: 400px;"></div>
						</div>
					</el-collapse-transition>
				</el-card>
			</el-collapse-transition>
				...
				<el-card v-show="cardTypeList.closeordersChartType4" class="card_view">
					<template #header>
						<div class="index_card_head">
							...
							<div class="card_head_right">
								<el-icon @click="cardTypeClick('hiddenordersChartType4')" class="showIcons"
									:class="cardTypeList.hiddenordersChartType4?'showIcons1':''">
									<ArrowUpBold />
								</el-icon>
								<el-icon @click="cardTypeClick('closeordersChartType4')" class="closeIcons">
									<CloseBold />
								</el-icon>
							</div>
						</div>
					...
					<el-collapse-transition>
						<div class="card_item" v-show="cardTypeList.hiddenordersChartType4">
							<div id="orderstotalEchart4" style="width: 100%;height: 400px;"></div>
						</div>
					</el-collapse-transition>
				</el-card>
			</el-collapse-transition>
...
<script setup>
	...
	const getordersChart2 = () => {
		nextTick(()=>{
			var totalEchart2 = echarts.init(document.getElementById("orderstotalEchart2"),'macarons');
			context?.$http({
	...
	const getordersChart3 = () => {
		nextTick(()=>{
        //  total
			var totalEchart3 = echarts.init(document.getElementById("orderstotalEchart3"),'macarons');
			context?.$http({
	...
	const getordersChart4 = () => {
		nextTick(()=>{
        //  total
			var totalEchart4 = echarts.init(document.getElementById("orderstotalEchart4"),'macarons');
			context?.$http({
